...
#define pack_glBlendEquationSeparateOES(modeRGB, modeA) ({ \
...
#define emit_glBlendEquationSeparateOES(modeRGB, modeA) { \
    mock_push(pack_glBlendEquationSeparateOES(modeRGB, modeA)); \
}
#define test_glBlendEquationSeparateOES(modeRGB, modeA) { \
...
#define gles_glBlendEquationSeparateOES_ARG_NAMES modeRGB, modeA
#define gles_glBlendEquationSeparateOES_ARG_EXPAND GLenum modeRGB, GLenum modeA
